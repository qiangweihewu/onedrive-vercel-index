...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'bypassgfw@outlook.com',
  ...
  email: 'mailto:qiangweihewu@proton.me',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/qiangweihewu/onedrive-vercel-index',
    },
  ],
